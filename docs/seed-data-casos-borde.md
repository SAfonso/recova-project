...
- Casos de borde incluidos:
  ...
  - **Doblete**: un cómico con solicitud del mismo día para ambos proveedores.
  - **Restringido activo**: solicitud en estado `normalizado` para validar exclusión en scoring.
- Coherencia de UUIDs entre `proveedores`, `comicos_master`, `solicitudes_bronze` y `solicitudes_silver`.
