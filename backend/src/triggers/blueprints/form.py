...
def create_form() -> tuple:
    ...
    membership_err = require_org_member(user["sub"], open_mic_id)
    if membership_err:
    ...
    try:
        ...
        return api_error("EXTERNAL_SERVICE_ERROR", "error al consultar open_mic", 502)
    ...
    try:
        ...
        return api_error("EXTERNAL_SERVICE_ERROR", "error al crear el formulario", 502)
    ...
    try:
        ...
        return api_error("EXTERNAL_SERVICE_ERROR", "error al guardar config", 502)
...
def analyze_form() -> tuple:
    ...
    try:
        ...
        return api_error("UNPROCESSABLE_ENTITY", "Gemini devolvió JSON inválido", 422)
...
def propose_custom_rules() -> tuple:
    ...
    try:
        ...
        return api_error("EXTERNAL_SERVICE_ERROR", "error al guardar reglas", 502)
